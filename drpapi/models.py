...
class Route(models.Model):
    ...
    startlocation = models.ForeignKey(Location, on_delete=models.CASCADE, related_name='startloc', blank=True, null=True)
    endlocation = models.ForeignKey(Location, on_delete=models.CASCADE, related_name='endloc', blank=True, null=True)
